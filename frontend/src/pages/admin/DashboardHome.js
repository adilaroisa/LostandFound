...
import { 
    ...
    CalendarDaysIcon // Tambahan icon kalender
    ...
    return (
        ...
        >
            <motion.div className="welcome-banner" variants={itemVariants}>
                ...
                {/* Menggunakan inline-flex agar icon dan text sejajar rata tengah */}
                <div style={{marginTop:'15px', background:'rgba(255,255,255,0.2)', display:'inline-flex', alignItems: 'center', padding:'5px 15px', borderRadius:'20px', fontSize:'0.9rem'}}>
                    <CalendarDaysIcon style={{ width: '18px', marginRight: '8px' }} />
