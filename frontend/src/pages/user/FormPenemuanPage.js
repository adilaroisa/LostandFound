...
const FormPenemuanPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const confirmResult = await Swal.fire({
      title: 'Kirim Laporan Penemuan?',
      text: "Pastikan foto bukti dan keterangan barang sudah jelas dan benar.",
      icon: 'question',
      showCancelButton: true,
    ...
    if (!confirmResult.isConfirmed) {
      return; // Berhenti jika user klik "Cek Kembali"
    }
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="form-footer">
              ...
              <div className="button-group">
                <button type="button" onClick={handleCancel} className="btn btn-cancel">Batal</button>
      ...
      {showSuccessModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <p className="modal-text">Data Anda berhasil disimpan dan akan ditinjau Admin.</p>
            <div className="modal-actions">
              {/* Redirect diperbaiki ke /list-penemuan */}
              <button onClick={() => navigate('/list-penemuan')} className="btn-modal-primary">Lihat List Barang</button>
