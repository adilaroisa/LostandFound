...
const FormKehilanganPage = () => {
  ...
  const handleNext = () => {
    if (validateStep(currentStep)) {
      ...
      // Auto-scroll ke pesan error pertama
      setTimeout(() => {
            ...
            {currentStep === 1 && (
              <div className="step-content">
                ...
                <div className="input-group">
                  ...
                  <input type="text" name="reporter_name" value={formData.reporter_name} onChange={handleChange} className={`custom-input ${errors.reporter_name ? 'error' : ''}`} />
                ...
                <div className="input-group">
                  ...
                  <input type="tel" name="reporter_phone" value={formData.reporter_phone} onChange={handleChange} className={`custom-input ${errors.reporter_phone ? 'error' : ''}`} />
                ...
                <div className="input-group">
                  ...
                  <input type={identityRules.inputType === 'numeric' ? 'tel' : 'text'} name="identification_number" value={formData.identification_number} onChange={handleChange} className={`custom-input ${errors.identification_number ? 'error' : ''}`} />
            ...
            {currentStep === 2 && (
              <div className="step-content">
                ...
                <div className="input-group">
                  ...
                  <input type="text" name="item_name" value={formData.item_name} onChange={handleChange} className={`custom-input ${errors.item_name ? 'error' : ''}`} />
                ...
                <div className="input-group">
                  ...
                  <textarea name="description" rows="4" value={formData.description} onChange={handleChange} className={`custom-textarea ${errors.description ? 'error' : ''}`}></textarea>
                ...
                <div className="two-col">
                  ...
                  <div className="input-group">
                    ...
                    <input type="text" name="location" value={formData.location} onChange={handleChange} className={`custom-input ${errors.location ? 'error' : ''}`} />
        ...
        <div className="popup-overlay">
          <div className="popup-card">
            ...
            <div className="popup-buttons">
              <button onClick={() => navigate('/list-kehilangan')} className="popup-primary">Lihat List Barang</button>
